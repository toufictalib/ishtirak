...
public class SearchTablePanel extends ReportTablePanel {

    public SearchTablePanel(String title) {
	super(title, null);
	start();
    }
   ...
   /* @Override
	...
	btnSearch.addActionListener(e -> {
		...
		ReportTableModel reportTableModel = ServiceProvider.get().getReportServiceImpl()
			.getCounterReport(dateRange.getStartDateAsString(), dateRange.getEndDateAsString());
