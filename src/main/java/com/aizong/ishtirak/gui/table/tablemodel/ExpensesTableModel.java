...
public class ExpensesTableModel extends AbstractTableModel {
    ...
    public ExpensesTableModel(Map<String, Map<String, Double>> map) {
	super();
	...
	if (col == 0) {
		...
		return ServiceProvider.get().getMessage().getEnumLabel(ExpensesType.values()[row].toString(), ExpensesType.class);
	    }
