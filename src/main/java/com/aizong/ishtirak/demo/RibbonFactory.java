...
public class RibbonFactory {
	...
	public List<RibbonBandResizePolicy> getDefaultPoliciesFor(JRibbonBand band) {
	    ...
	    Mid2Mid mirror = new CoreRibbonResizePolicies.Mid2Mid(band.getControlPanel());
	    Mid2Low mid2Low = new CoreRibbonResizePolicies.Mid2Low(band.getControlPanel());
	    
	    return new Vector<RibbonBandResizePolicy>(Arrays.asList((RibbonBandResizePolicy)mirror, (RibbonBandResizePolicy)mid2Low));
	}
	...
	public static ResizableIcon getResizableIconFromResource(URL resource) {
		return getResizableIconFromResource(RibbonFactory.class
			.getClassLoader().getResource(
				"images/menus/48px_customer.png"), new Dimension(48, 48));
	}
	...
	public static ResizableIcon getResizableIconFromResource(String resource) {
		return getResizableIconFromResource(RibbonFactory.class
				.getClassLoader().getResource("menus/48px_customer.png"), new Dimension(48, 48));
	}
